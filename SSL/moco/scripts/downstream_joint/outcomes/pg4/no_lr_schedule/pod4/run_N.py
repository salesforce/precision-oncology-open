...
out_dir = "/export/medical_ai/ucsf/ssl_rtog/moco/model_R50_b=256_lr=0.03_pg4plus/distant_met_5year/joint_training/no_lr_schedule/pod4/"
command = """
python train_multimodal_model.py \
  ...
  --output_dir="/export/medical_ai/ucsf/ssl_rtog/moco/model_R50_b=256_lr=0.03_pg4plus/distant_met_5year/joint_training/no_lr_schedule/pod4/run{}" \
""".strip()
